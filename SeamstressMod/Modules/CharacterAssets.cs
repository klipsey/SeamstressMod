...
{
    internal static class CharacterAssets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SeamstressMod." + bundleName))
                {
        ...
        internal static GameObject CreateProjectileGhostPrefab(this AssetBundle assetBundle, string ghostName)
        {
            ...
            Modules.CharacterAssets.ConvertAllRenderersToHopooShader(ghostPrefab);
