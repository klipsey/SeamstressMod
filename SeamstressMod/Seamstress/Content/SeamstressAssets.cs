...
namespace SeamstressMod.Seamstress.Content
{
    public static class SeamstressAssets
    {
        ...
        private static void CreateEffects()
        {
            ...
            sex.startLifetimeMultiplier = 0.6f;
            sex.startRotation3D = false;
            Modules.Content.CreateAndAddEffectDef(uppercutEffect2);
            ...
            Modules.Content.CreateAndAddEffectDef(insatiableEndEffect);
            ...
            Modules.Content.CreateAndAddEffectDef(insatiableEndEffect2);
