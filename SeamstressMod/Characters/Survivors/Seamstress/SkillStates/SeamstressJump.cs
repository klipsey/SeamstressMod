...
namespace SeamstressMod.SkillStates
{
    public class SeamstressJump : BaseSeamstressState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (this.inputBank.jump.justPressed && this.isGrounded && this.seamCon.blinkReady)
            {
            ...
            else if (this.inputBank.jump.justPressed && base.characterMotor.jumpCount >= base.characterBody.maxJumpCount && this.seamCon.blinkReady)
            {
                this.seamCon.blinkReady = false;
                this.seamCon.blinkCd = SeamstressStaticValues.blinkCooldown;
