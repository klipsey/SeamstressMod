...
namespace SeamstressMod.Survivors.Seamstress
{
    public static class SeamstressBuffs
    {
        ...
        public static void Init(AssetBundle assetBundle)
        {
            ...
            stitched = Modules.Content.CreateAndAddBuff("Stitched", Addressables.LoadAssetAsync<Sprite>("RoR2/DLC1/MoveSpeedOnKill/texBuffKillMoveSpeed.tif").WaitForCompletion(), 
                Color.red, true, true);
        }
    }
}
