...
namespace SeamstressMod.Survivors.Seamstress
{
    ...
    {
        internal const float needleGainInterval = 10f;

        internal const float scissorsDamageCoefficient = 1.8f;

        internal const float cutDotDamage = 0.001f;

        internal const float cutDotBossDamage = 0.0005f;

        internal const float weaveLifeSteal = 0.25f;

        internal const float cutDuration = 5f;
